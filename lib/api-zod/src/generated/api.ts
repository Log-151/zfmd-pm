...
export const ListWorkOrdersResponseItem = zod.object({
  ...
  contractId: zod.number().nullish(),
  contractNo: zod.string().nullish(),
  cancelTime: zod.string().nullish(),
  costIncurred: zod.string().nullish(),
  costHandling: zod.string().nullish(),
  circulationTime: zod.string().nullish(),
  customer: zod.string(),
  province: zod.string(),
  group: zod.string(),
  station: zod.string(),
  ...
  projectContent: zod.string().nullish(),
  salesManager: zod.string(),
  briefingTime: zod.string().nullish(),
  ...
  acceptanceTime: zod.string().nullish(),
